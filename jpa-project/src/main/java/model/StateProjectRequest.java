...
public class StateProjectRequest implements Serializable {
	...
	@Id
	@SequenceGenerator(name="STATE_PROJECT_REQUEST_STATEPROJECTREQUESTID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="STATE_PROJECT_REQUEST_STATEPROJECTREQUESTID_GENERATOR")
