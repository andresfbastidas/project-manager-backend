...
public interface ProjectRequestRepository extends JpaRepository<ProjectRequest, Long> {
	...
	public Page<ProjectRequest> findProjectRequestByStateForDirector(Pageable pageable, Long stateApproval,
	...
	@Query(value = "select pr.project_request_id,pj.project_id, pj.project_title, pj.project_summary, \n"
			...
			+ "sr.state_project_request_id= pr.state_project_request_id and usr.user_name=pr.user_name", nativeQuery = true)
	public Page<ProjectRequest> findProjectRequestByStateForUser(Pageable pageable, Long stateApproval,
			Long stateDecline, Long statePending, String userName) throws ProjectManagementException;
