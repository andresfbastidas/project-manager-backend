...
/**
 * The persistent class for the "ProjectDelivery" database table.
 * 
 */
@Entity
@Table(name="ProjectDelivery")
...
public class ProjectDelivery implements Serializable {
	...
	@Id
	@SequenceGenerator(name="PROJECTDELIVERYID_GENERATOR", sequenceName="PROJECTDELIVERY_SEQ", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PROJECTDELIVERYID_GENERATOR")
